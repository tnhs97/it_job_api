                ...
                <div class="box-header with-border">
                    ...
                    <div class="box-tools">
                        ...
                        <div class="btn-group pull-right" style="margin-right: 5px">
                            <a href="{{ route('shop_small_category')}}" class="btn btn-sm btn-default" title="List"><i class="fa fa-list"></i><span class="hidden-xs">&nbsp;List</span></a>
                        </div>
                    </div>
                </div>
                <!-- /.box-header -->
                <!-- form start -->
                <form action="{{ route('geteditSmallCategory',$data['id']) }}" method="POST" enctype="multipart/form-data" class="form-horizontal" pjax-container>
...
<label for="txt_id_category" class="col-sm-2  control-label">Category name
</label>

    <div class="col-sm-8">

        
        <input type="hidden" name="txt_id_category"/>

        <select class="form-control product_id" style="width: 100%;" name="txt_id_category" >
                            <option value="{!! old('txt_id_category',isset($data)? $data['id_category']: null) !!}"></option>
...
<div class="form-group  ">
    ...
    <label for="en__name" class="col-sm-2  control-label">Category name
    </label>
    ...
    <div class="col-sm-8">
        ...
        <div class="input-group">
            ...
            <input type="text" id="en__name" name="txt_CateName" value="{!! old('txt_CateName',isset($data)? $data['id_category']: null) !!}" class="form-control en__name" placeholder="Input Name" />
...
<div class="form-group  ">
    ...
    <label for="en__name" class="col-sm-2  control-label">Small category name
    </label>
    ...
    <div class="col-sm-8">
        ...
        <div class="input-group">
            ...
            <input type="text" id="en__name" name="txt_SmallCateName" value="{!! old('txt_SmallCateName',isset($data)? $data['nameSmallCate']: null) !!}" class="form-control en__name" placeholder="Input Name" />
...
<div class="form-group  ">
    ...
    <div class="col-sm-8">
        ...
        <textarea name="txt_SmallCateDecription" class="form-control comment" rows="5" placeholder="Input Comment"  >
            {!! old('txt_SmallCateDecription',isset($data)? $data['descriptions']: null) !!}
        </textarea>
...
<div class="box-footer">
    ...
    <div class="col-md-8">
        ...
        <div class="btn-group pull-left">
            <a href="{{ route('shop_small_category')}}" class="btn btn-sm btn-default" title="Cancel"><i class="fa fa-list"></i><span class="hidden-xs">&nbsp;Cancel</span></a>
        </div>
    </div>
</div>
