                                ...
                                <table class="table table-hover">
                                    ...
                                    <tbody>
                                        ...
                                        <tr >
                                            ...
                                            <td >
                                                {{ $product-> descriptions_long }}
                                            </td>
                                            <td >
                                                <img src="{{ $product-> image }}" style='max-width:50px;max-height:200px' class='img img-thumbnail' />
                                            </td>
                                            <td >
                                                {{ $product-> color }}
                                            </td>
                                            ...
                                            <td >
                                                <input type="checkbox" class="grid-switch-status" />
                                            </td>
                                            <td >
